...
# # (Random -> --init-method normal 로 매핑)
# # =========================
# python main.py --dataset cifar10 --output-dir "./output/CIFAR10_#2.json" --use-rigl-admm --sparsity-method uniform --num_re_epochs 5 --num_pre_epochs 5
# python main.py --dataset cifar10 --output-dir "./output/CIFAR10_#3.json" --use-rigl-admm --sparsity-method er --num_re_epochs 5 --num_pre_epochs 5
# python main.py --dataset cifar10 --output-dir "./output/CIFAR10_#4.json" --use-rigl-admm --sparsity-method erk --num_re_epochs 5 --num_pre_epochs 5
